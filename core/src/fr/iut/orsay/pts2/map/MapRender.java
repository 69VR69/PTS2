        ...
        for (Map.Entry<Object, ArrayList<Cost>> ee : this.productionList.entrySet()) {
            ...
            if (o instanceof Unit) {
                if (((Unit) o).isOnBoard()) {
                    ...
                    final Texture texture = Tools.resize(((Unit) o).texturize(), (int) (CONSTANT.textureWidth * resizeRatio), (int) (CONSTANT.textureHeight * resizeRatio));
                    ...
                    Gdx.input.setInputProcessor(new InputProcessor() {
                        ...
                        public boolean touchDown(int screenX, int screenY, int pointer, int button) {
                            ...
                            unit.setPosX(screenX);
                            unit.setPosY(screenY);
                            batchUnit.draw(texture,unit.getPosX(),unit.getPosY());
                            unit.move(screenX,screenY);
                            batchUnit.end();
                            hud.render(batchUnit);
                            return true;
                        }
